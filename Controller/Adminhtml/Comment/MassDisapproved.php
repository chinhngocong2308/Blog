...
class Disapproved extends \Magento\Backend\App\Action {
    /**
    ...
    public function execute() {
        try{
            ...
            $this->messageManager->addSuccess('A total of %1 comment(s) were deleted successfully.', $itemsDisapproved);
        }catch(Exception $e){
